...
-- Preeto K and Anirudh Suri, for MODS
-- Out Line 
--The output of this is the SOFA scores that goes into training the GNN for MODS

create table sofa_version1 as
...
--  1) urine_output_first_day - generated by urine-output-first-day.sql DONE STORES IN SCHEMA 
--  2) vitals_first_day - generated by vitals-first-day.sql DONE STORES IN SCHEMA
--  3) gcs_first_day - generated by gcs-first-day.sql DONE STORES IN SCHEMA
--  4) labs_first_day - generated by labs-first-day.sql DONE STORES IN SCHEMA
--  5) blood_gas_first_day_arterial - generated by blood-gas-first-day-arterial.sql DONE STORES IN SCHEMA
--  6) echodata - generated by echo-data.sql DONE STORES IN SCHEMA
--  7) ventilation_durations - generated by ventilation_durations.sql DONE STORES IN SCHEMA
...
(
  ...
  -- on ie.icustay_id = cv.icustay_id and cv.charttime between ie.intime AND cv.charttime BETWEEN ie.intime AND ie.intime + INTERVAL '1 DAY'
  --  cv.charttime BETWEEN ie.intime AND ie.intime + INTERVAL '1 DAY'
...
(
  ...
  left join vent_duration_mit_lcp vd
